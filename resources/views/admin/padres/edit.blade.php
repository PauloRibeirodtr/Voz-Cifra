...
@section('title', 'Editar padre | Voz & Cifra')
@section('mobile_title', 'Editar padre')

@section('content')
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Editar padre</h1>
            <p class="text-sm text-gray-500">Atualize os dados e o vinculo administrativo do padre.</p>
        </div>
    ...
    <form action="{{ route('admin.padres.update', $padre) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
