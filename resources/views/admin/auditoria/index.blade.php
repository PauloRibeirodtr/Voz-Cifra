...
@section('content')
    ...
    <div class="mb-6 rounded-3xl border border-gray-200 bg-white p-5 shadow-sm">
        <form method="GET" class="grid grid-cols-1 gap-4 lg:grid-cols-5">
            <input type="text" name="q" value="{{ $filtros['q'] }}" placeholder="Buscar por protocolo, ator, alvo, email ou igreja" class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-gray-800 lg:col-span-3">
