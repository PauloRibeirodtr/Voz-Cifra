    ...
    <div class="mt-6 grid grid-cols-1 gap-6 xl:grid-cols-3">
        <section class="xl:col-span-2 rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
            <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h2 class="text-lg font-bold text-gray-900">Acessos rápidos</h2>
        ...
        <aside class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
            ...
            <div class="mt-4 space-y-4 text-sm text-gray-600">
                ...
                <div>
                    ...
                    <a href="{{ $igreja->link_publico_musicos }}" target="_blank" class="break-all text-green-700 hover:underline">{{ $igreja->link_publico_musicos }}</a>
                </div>
                <div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
                    <a href="{{ $igreja->qr_code_url }}" target="_blank" class="inline-flex items-center justify-center rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm font-semibold text-gray-700 transition hover:bg-gray-50">
                        Abrir QR dos fiéis
                    </a>
                    <a href="{{ $igreja->qr_code_url_musicos }}" target="_blank" class="inline-flex items-center justify-center rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm font-semibold text-gray-700 transition hover:bg-gray-50">
