...
<body class="bg-gray-50 font-sans text-gray-900" data-theme-preference="{{ $themePreference }}">
    ...
    <div class="min-h-screen md:pl-72">
        <header class="sticky top-0 z-20 border-b border-gray-200 bg-white/95 backdrop-blur md:hidden">
            <div class="flex items-center justify-between gap-3 px-4 py-3">
                <div class="min-w-0">
                    <p class="text-[11px] font-black uppercase tracking-[0.22em] text-emerald-700">Voz &amp; Cifra</p>
                    <h1 class="truncate text-base font-extrabold text-slate-900">@yield('mobile_title', 'Area do musico')</h1>
                </div>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <button
                        type="button"
                        id="member_sidebar_toggle"
                        class="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-gray-200 bg-white text-slate-700 shadow-sm transition hover:border-emerald-200 hover:bg-emerald-50 hover:text-emerald-700"
                        aria-controls="member_sidebar"
                        aria-expanded="false"
        ...
        <main class="relative overflow-x-hidden px-4 py-4 sm:px-6 sm:py-6 lg:px-8" id="mainContent">
            <div class="mb-6 hidden items-center justify-between gap-4 md:flex">
                <div class="min-w-0">
                    <p class="text-[11px] font-black uppercase tracking-[0.22em] text-emerald-700">Voz &amp; Cifra</p>
                    <p class="truncate text-sm text-slate-500">@yield('desktop_subtitle', 'Area do musico')</p>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const overlay = document.getElementById('member_sidebar_overlay');
